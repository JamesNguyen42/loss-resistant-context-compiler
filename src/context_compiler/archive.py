...
class SourceArchive:
    ...
    def append(self, records: Iterable[SourceRecord]) -> int:
        ...
        for record in incoming:
            ...
            # Validate every record before creating or touching the archive.
            # This prevents a stale or externally mutated record from turning a
            # successful append into an immediately corrupt event log.
        ...
        with self.events_path.open("r", encoding="utf-8") as stream:
            for line_number, line in enumerate(stream, start=1):
                ...
                try:
                    ...
                    raise ValueError(
                        f"invalid archive record at line {line_number}: {exc}"
                    ) from exc
