...
| Area | Current state |
| --- | --- |
| Release | Alpha research implementation, package version `0.1.1a10` |
...
| OpenHands integration | Separately packaged `ctxc-openhands` `0.1.0a11` draft alpha; reviewed offline fake-runtime foundation only; live execution blocked |
...
`0.1.0a11` package under `integrations/openhands/`. Ordinary
