...
WHEEL = "loss_resistant_context_compiler-0.1.1a14-py3-none-any.whl"
SDIST = "loss_resistant_context_compiler-0.1.1a14.tar.gz"
ROOT = "loss_resistant_context_compiler-0.1.1a14"
MATRIX_REVISION = "1" * 40
MATRIX_ROOT_WHEEL = "loss_resistant_context_compiler-0.1.1a14-py3-none-any.whl"
MATRIX_INTEGRATION_VERSION = "0.1.0a15"
...
def _write_wheel(path: Path, *, timestamp: tuple[int, int, int, int, int, int]) -> None:
    entries = {
        "context_compiler/__init__.py": b'__version__ = "0.1.1a14"\n',
        "loss_resistant_context_compiler-0.1.1a14.dist-info/METADATA": (
            b"Metadata-Version: 2.4\nName: loss-resistant-context-compiler\nVersion: 0.1.1a14\n"
        ),
        "loss_resistant_context_compiler-0.1.1a14.dist-info/WHEEL": (
            b"Wheel-Version: 1.0\nRoot-Is-Purelib: true\nTag: py3-none-any\n"
        ),
        "loss_resistant_context_compiler-0.1.1a14.dist-info/RECORD": b"",
    }
