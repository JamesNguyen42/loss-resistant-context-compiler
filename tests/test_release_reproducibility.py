...
ROOT = "loss_resistant_context_compiler-0.1.1a16"
MATRIX_REVISION = "1" * 40
MATRIX_ROOT_WHEEL = "loss_resistant_context_compiler-0.1.1a16-py3-none-any.whl"
MATRIX_INTEGRATION_VERSION = "0.1.0a17"
...
def _write_wheel(path: Path, *, timestamp: tuple[int, int, int, int, int, int]) -> None:
    entries = {
        "context_compiler/__init__.py": b'__version__ = "0.1.1a16"\n',
        "loss_resistant_context_compiler-0.1.1a16.dist-info/METADATA": (
            b"Metadata-Version: 2.4\nName: loss-resistant-context-compiler\nVersion: 0.1.1a16\n"
        ),
        "loss_resistant_context_compiler-0.1.1a16.dist-info/WHEEL": (
            b"Wheel-Version: 1.0\nRoot-Is-Purelib: true\nTag: py3-none-any\n"
        ),
        "loss_resistant_context_compiler-0.1.1a16.dist-info/RECORD": b"",
    }
    ...
    for lane in PACKAGE_MATRIX_LANES:
        ...
        probe = {
            ...
            "integration_requirements": [
                "loss-resistant-context-compiler==0.1.1a16",
