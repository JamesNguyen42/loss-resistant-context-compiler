...
@pytest.mark.parametrize(
    "invalid_wheel",
    [
        "loss_resistant_context_compiler-0.1.1a11-not-a-valid-wheel.whl",
        "loss_resistant_context_compiler-0.1.1a11-cp311-cp311-win_amd64.whl",
        "loss_resistant_context_compiler-0.1.1a11-1-py3-none-any.whl",
    ],
)
