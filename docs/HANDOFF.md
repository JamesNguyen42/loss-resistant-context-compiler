...
| OpenHands integration | Separate `ctxc-openhands` `0.1.0a14` draft alpha; offline fake-runtime foundation only; live execution and recorded live scenario blocked |
...
| OpenHands integration version | `0.1.0a14` draft alpha |
