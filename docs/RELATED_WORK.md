...
| This project | Loss-resistant active-context compilation | Optional exact-span model extractor; deterministic core | Exact source spans and independent checks | 163 tests plus local synthetic LRCBench |
