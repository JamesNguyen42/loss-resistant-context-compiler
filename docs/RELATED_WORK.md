...
> No named external system has produced a scoreable candidate in this
> repository. Result-blind screens and a retained failed ACON diagnostic do not
> support an external state-of-the-art or "50% better than most" claim.
...
| This project | Loss-resistant active-context compilation | Optional exact-span model extractors; deterministic core | Exact source spans and independent checks | 1,414 collected tests (1,399 passed, 15 skipped), local synthetic LRCBench, replayable exact-Qwen diagnostics, a non-claim-bearing offset ablation, a retained 128-call paired result, and non-scoreable external preflights |
