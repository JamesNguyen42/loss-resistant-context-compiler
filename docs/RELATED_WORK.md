...
| This project | Loss-resistant active-context compilation | Optional exact-span model extractor; deterministic core | Exact source spans and independent checks | 798 tests, local synthetic LRCBench, a 64-case phrase diagnostic, and a replayable 64-call exact-Qwen diagnostic |
