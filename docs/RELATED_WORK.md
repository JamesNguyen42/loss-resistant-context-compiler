...
| This project | Loss-resistant active-context compilation | Optional exact-span model extractors; deterministic core | Exact source spans and independent checks | 832 tests, local synthetic LRCBench, a 64-case phrase diagnostic, and a replayable 64-call exact-Qwen diagnostic |
